  ...
  <div>
    ...
    <div className="border border-main rounded-xl p-6">
      <div className="px-4 flex items-center justify-center">
        <div
          className="flex justify-between py-1 px-2 w-full border border-main rounded-xl"
        >
          <input
        ...
        <div
          className="flex px-3 py-1 ml-4 border border-main rounded-lg cursor-pointer"
        >
        ...
        <div
          className="flex px-3 py-1 ml-4 border border-main rounded-lg w-1/2 cursor-pointer"
        >
      ...
      <div className="flex justify-between px-4">
        ...
        <div className="flex">
          ...
          <div
            className="bg-sub rounded-lg px-3 py-1 mx-4 border border-main text-gray-800"
          >
            2
          </div>
          <div className="py-1">
        ...
        <div className="flex font-semibold text-gray-700">
          ...
          <div
            className="bg-sub rounded-lg px-3 py-1 border border-main text-gray-700"
          >
            50
          </div>
        </div>
      ...
      <div className="flex">
        <div className="w-1/2 p-2 border">
          <div>Pros</div>
          <div>{{ positiveData }}</div>
        </div>
        <div className="w-1/2 p-2 border">
          <div>Cons</div>
          <div>{{ negativeData }}</div>
        </div>
      </div>
